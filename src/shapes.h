...
public:
	...
	virtual void calculate_uv(simd_vec3 &calculator, simd_mat4 &calculator_m, vec3 &hit_point, float &u, float &v) const = 0;
	virtual void get_tangent(simd_vec3 &calculator, simd_mat4 &calculator_m, vec3 &hit_point, vec3 &tangent) const = 0;
...
public:
	...
	virtual void calculate_uv(simd_vec3 &calculator, simd_mat4 &calculator_m, vec3 &hit_point, float &u, float &v) const override;

	virtual void get_tangent(simd_vec3 &calculator, simd_mat4 &calculator_m, vec3 &hit_point, vec3 &tangent) const override;
